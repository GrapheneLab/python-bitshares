...
class Address(GPHAddress):
    """ Address class
        ...
        :param str prefix: Network prefix (defaults to ``GRV``)

        Example::

           Address("GRVFN9r6VYzBK8EKtMewfNbfiGCr56pHDBFi")

    """
    def __init__(self, *args, **kwargs):
        if "prefix" not in kwargs:
            kwargs["prefix"] = "GRV"  # make prefix GRV
...
class PublicKey(GPHPublicKey):
    """ This class deals with Public Keys and inherits ``Address``.
        ...
        Example:::
           ...
           PublicKey("GRV6UtYWWs3rkZGV8JA86qrgkG6tyFksgECefKE1MiH4HkLD8PFGL")
